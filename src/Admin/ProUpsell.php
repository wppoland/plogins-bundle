...
/**
 * PRO upgrade promotion, shown ONLY on the Bundle settings screen: a dismissible
...
final class ProUpsell
{
    ...
    {
        /**
         * Filters whether the Bundle PRO promo is shown on the settings screen.
         *
    ...
    private function priceLabel(): string
    {
        ...
        if ($this->isPolish() && ! empty($d['price_pln'])) {
            ...
            return sprintf(__('od %d zł/rok', 'plogins-bundle'), (int) $d['price_pln']);
        }
    ...
    public function handleDismiss(): void
    {
        if (! current_user_can('manage_woocommerce')) {
            wp_die(esc_html__('Permission denied.', 'plogins-bundle'));
        }
    ...
    public function banner(): void
    {
        ...
        $name     = (string) ($this->data()['name'] ?? 'Bundle Pro');
        ...
        <div class="bundle-pro-banner" role="note">
            ...
            <p class="bundle-pro-banner__text">
                ...
                printf(esc_html__('Do more with %s', 'plogins-bundle'), esc_html($name)); ?></strong>
    ...
    public function cards(): void
    {
        ...
        <section class="bundle-pro-cards" aria-labelledby="bundle-pro-cards-h">
            <h2 id="bundle-pro-cards-h" class="bundle-pro-cards__title">
                <?php
                /* translators: %s: PRO edition name */
                printf(esc_html__('What %s adds', 'plogins-bundle'), esc_html($name)); ?>
            </h2>
